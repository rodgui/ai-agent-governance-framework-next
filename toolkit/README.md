...
| Governar múltiplos control planes | [ADR-0015](../docs/architecture/decisions/0015-multi-control-plane-arbitration.md) → [Multi-Control-Plane pattern](patterns/multi-control-plane-governance.md) → [Exemplo de conflito](examples/multi-control-plane-conflict.example.md) | Authorities, source of truth, precedência, fail-safe e evidence cross-plane. |
...
| Avaliar ou substituir um orchestrator | [Orchestrator Technology Evaluation](assessments/technology-evaluations/orchestrator-evaluation.md) → [Orchestrator Decision/Exit Record](templates/orchestrator-decision-exit-record.md) → [ADR-0015](../docs/architecture/decisions/0015-multi-control-plane-arbitration.md) → [Exemplo de decisão](examples/orchestrator-decision-exit-record.example.md) | Pattern fit, capabilities, authority, evidence, portability, lock-in, resilience e exit. |
