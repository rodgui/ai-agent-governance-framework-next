...
- decisão e capability em análise;
- escopo, alternativas e critérios antes da coleta;
- requisitos funcionais, segurança, identidade, dados, observabilidade, portabilidade e custo;
- evidências reproduzíveis, data de corte e limitações;
- lock-in, reversibilidade e exit plan;
