...
- Três expressões herdadas do contexto em que a Policy v1 foi redigida (`OWCR`,
  `Group/Segment/Local` e `Group/Segments/Locations`) foram substituídas por formulação
