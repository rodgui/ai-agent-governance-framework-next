...
- Três expressões herdadas do contexto organizacional em que a Policy v1 foi redigida
  foram substituídas por formulação neutra em
  `project/history/ai-agent-policy-and-governance-v1.md` e em
