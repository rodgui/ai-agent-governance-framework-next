...
> (`ai-agent-governance-private`) e o ponto de partida de implementação
...
| **consulting** | vai vender ou entregar serviço sobre o framework | [README](https://github.com/rodgui/ai-agent-governance-private) → `offerings/README.md` |
