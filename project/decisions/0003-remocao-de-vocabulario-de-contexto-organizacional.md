...
- `OWCR`, sigla de métrica operacional que não pertence ao vocabulário de governança de IA;
- `Group/Segment/Local`, estrutura de níveis de governança corporativa;
- `Group/Segments/Locations`, a mesma estrutura em outra flexão.
...
| Antes | Depois |
|---|---|
| `The rules apply at all levels (Group/Segment/Local)` | `The rules apply at every organizational level` |
| `critical KPIs (production, safety, quality, OWCR, etc.)` | `critical KPIs (production, safety, quality, cost, etc.)` |
| `adoptable at scale (Group/Segments/Locations)` | `adoptable at scale across the organization` |
